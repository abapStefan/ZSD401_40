...
CLASS lcl_flights DEFINITION.
  PUBLIC SECTION.
    ...
    METHODS access_standard_second_key.
    METHODS access_standard_second_key_2.
    METHODS acess_second_key_unique_1.
    METHODS acess_second_key_unique_2.
  ...
  PRIVATE SECTION.
    ...
    DATA standard_table TYPE STANDARD TABLE OF /lrn/passflight
                        ...
                        WITH NON-UNIQUE SORTED KEY s_key COMPONENTS carrier_id connection_id flight_date
                        WITH UNIQUE SORTED KEY s_key_unique COMPONENTS carrier_id connection_id flight_date.
...
CLASS lcl_flights IMPLEMENTATION.
  ...
  METHOD access_standard_second_key.

  DATA(result) = standard_table[ KEY s_key carrier_id    = me->carrier_id
                                           connection_id = me->connection_id
                                           flight_date   = me->flight_date
                                           ].
  ...
  METHOD access_standard_second_key_2.
  ...
  METHOD acess_second_key_unique_1.

  DATA(result) = standard_table[ KEY s_key_unique carrier_id    = me->carrier_id
                                                  connection_id = me->connection_id
                                                  flight_date   = me->flight_date
                                                  ].
  ...
  METHOD acess_second_key_unique_2.
