...
*
*    IF sy-subrc <> 0.
*    cl_abap_unit_assert=>fail( 'Keine Daten in der Tabelle Cargoflight' ).
*    ENDIF.
*
*    TRY.
...
*    ENDTRY.
    ...
    cl_abap_unit_assert=>assert_bound(
                 act    = flight
                 msg    = 'Die Methode find_cargo_flight liefert ken Ergrbnis' ).
...
*        the_carrier = NEW lcl_carrier( i_carrier_id = some_flight_data-carrier_id ).
      ...
      CATCH cx_abap_auth_check_exception.
        cl_abap_unit_assert=>fail( 'lcl_carrier kann nicht instanziiert werden' ).        " Übung 18_6
