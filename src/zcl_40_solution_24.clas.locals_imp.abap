...
CLASS lcl_carrier DEFINITION CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS get_instance           " Aus Übung 23
      ...
      RAISING
        cx_abap_invalid_value            " Aus Übung 23
        cx_abap_auth_check_exception.    " Aus Übung 23
...
*      INTO ( @me->name, @me->currency_code ). " Übung 23
    ...
    IF sy-subrc <> 0.
      RAISE EXCEPTION TYPE cx_abap_invalid_value  " Übung 24
           EXPORTING
    ...
    IF sy-subrc <> 0.
      ...
      RAISE EXCEPTION TYPE cx_abap_auth_check_exception   " Übung 24
      EXPORTING
                   textid =
