...
CLASS lcl_passenger_flight DEFINITION INHERITING FROM lcl_flight .
  ...
  PUBLIC SECTION.
    ...
    METHODS get_free_seats RETURNING VALUE(r_result) TYPE i.
...
CLASS lcl_passenger_flight IMPLEMENTATION.
  ...
  METHOD get_flights_by_carrier.
    ...
    IF NOT line_exists(  flights_buffer[ KEY sk_carrier
  ...
  METHOD get_description.
    ...
    APPEND |{ 'Duration:'(011) }       { connection_details-duration } minutes| TO r_result.
